...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    emailjs
      .sendForm('service_n5wpgro', 'template_wu0htag', form.current, 'fl0Nw51IW3UnIMpM9')
      .then(
        (result) => {
      ...
      <Wrapper>
        ...
        >
          <Alert
            ...
            sx={{ width: '100%' }}
          >
            {alertType === 'success' ? 'Email sent successfully!' : 'Failed to send email. Please try again.'}
          </Alert>
        </Snackbar>
      </Wrapper>
    </Container>
